...
<head>
  ...
  <link href="https://cdn.datatables.net/1.10.18/css/dataTables.bootstrap.min.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="{{url('AdminLTE/bower_components/datatable/js/jszip.min.js')}}"></script>
    <script type="text/javascript" src="{{url('AdminLTE/bower_components/datatable/js/pdfmake.min.js')}}"></script>
    <script type="text/javascript" src="{{url('AdminLTE/bower_components/datatable/js/vfs_fonts.js')}}"></script>
