      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-solid">
            <!-- /.box-header -->
            <form method="post"  action="{{url('/data-pasien/update')}}" enctype="multipart/form-data" class="form-horizontal">
              {{csrf_field()}}
            ...
            <div class="box-body">
              ...
              <div class="row">
                <div class="col-xs-7 col-md-8 text-center">
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          <textarea class="form-control" rows="3" name="keluhan" value="">{{$data->keluhan}}-</textarea>
                      </div>
                    </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-xs-7 col-md-4 text-center">
                    <div class="form-group">
                      <label class="col-sm-4 control-label" style="text-align: left; padding-left: 20pt">Uang Pangkal</label>
                ...
                <div class="col-xs-7 col-md-4 text-left">
                      <div class="form-group">
                ...
                <div class="col-xs-7 col-md-4 text-left">
                      <div class="form-group">
                        <label class="col-sm-5 control-label" style="text-align: left; padding-left: 20pt">Evaluasi</label>
              ...
              <!-- end data pasien-->
                    ...
                    <div class="box-body">
                      ...
                      <div class="row">
                         <div class="col-xs-7 col-md-6 text-center">
                            <div class="form-group">
                              <label class="col-sm-3 control-label" style="text-align: left; padding-left: 20pt">Pekerjaan
                              </label>
                              <div class="col-sm-9" style="padding-left: 5pt">
                        ...
                        <div class="col-xs-7 col-md-6 text-center">
                            <div class="form-group">
                              <label class="col-sm-2 control-label" style="text-align: left; padding-left: 20pt">Pend. Terakhir</label>
                              <div class="col-sm-6">
                                <input type="text" class="form-control" value="{{$data->pend_ayah}}" name="pendTerakhir_A" required>
                              </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-xs-7 col-md-6 text-center">
                            <div class="form-group">
                              ...
                              <div class="col-sm-9" style="padding-left: 12pt">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-7 col-md-6 text-center">
                            <div class="form-group">
                              ...
                              <div class="col-sm-7" style="padding-left: 55pt; padding-top: 0pt">
                      ...
                      <div class="row">
                        <div class="col-xs-7 col-md-6 text-center">
                            <div class="form-group">
                              ...
                              <div class="col-sm-8" style="padding-left: 5pt">
