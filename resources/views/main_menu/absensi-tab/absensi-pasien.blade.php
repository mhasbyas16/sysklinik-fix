          ...
          <div class="col-xs-12">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body">
                ...
                <a href="{{url('/absensi/export')}}/{{$Dawal}}/{{$Dakhir}}"><button type="button" class="btn btn-success">
                  Export Data 2
                </button></a>
              </div>
              <!-- /.box-body -->
              ...
              <div class="row">
                <div class="col-xs-12">
                  ...
                  <div class="box box-solid">
                    <!-- /.box-header -->
                    <div class="box-body">
                      <table id="absensiPasienM" class="display text-center" style="width:100%;display:none;" >
                        <thead>
                          <tr>
                            <th>Nama</th>
                            <th>Tanggal</th>
