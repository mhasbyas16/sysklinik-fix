            ...
            <form class="form-horizontal">
                      ...
                      <div class="row">
                        <div class="col-xs-7 col-md-12 text-left">
                            <div class="form-group">
                              <label class="col-sm-12"><h3>Payslip xxx Bulan xxx</h3><hr></label>
                            </div>
                        </div>
                      </div>
                    ...
                    <div class="box-body">
                      <div class="row">
                        <div class="col-xs-7 col-md-12 text-left">
                            <div class="form-group">
                              <label class="col-sm-12"><h3></h3><hr></label>
                              <br>
                              <br>
                              <div class="button">
                                  <ul style="padding-left: 100pt">
                                    <button class="col-sm-1 btn btn-secondary" href="#" style="text-align: center;">
                                    Refresh
                                    </button>
                                    <button class="col-sm-1 btn btn-info" href="#" style="text-align: center; margin-left: 10pt">
                                    Print
                                    </button>
                                    <button class="col-sm-1 btn btn-primary" href="#" style="text-align: center; margin-left: 10pt">
                                    Export
                                    </button>
                                    <button class="col-sm-2 btn btn-success" href="#" style="text-align: center; margin-left: 354pt">
                                    Save
                                    </button>
                                  </ul>
                              </div>
